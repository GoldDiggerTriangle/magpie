...
from apps.research.views import (
    ...
    PricingEvidenceCaptureDraftView,
    PricingEvidenceView,
    ResearchLinksView,
...
urlpatterns = [
    ...
    path(
        "items/<uuid:item_id>/pricing-evidence/capture-draft/",
        PricingEvidenceCaptureDraftView.as_view(),
        name="item-pricing-evidence-capture-draft",
    ),
